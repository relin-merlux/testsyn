...
<div style="background: #1e7ad2; width: 100%; -webkit-box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75); margin-top: 20px; padding: 10px 20px 10px 20px; color: #fff; -moz-box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75); box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.75);">START YOUR 7 DAYS FREE TRIAL &gt;&gt;</div>

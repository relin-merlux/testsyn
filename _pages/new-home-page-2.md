...
<p style="margin: 0px; font-size: 45px;"><span style="color: #6699cc;"><strong><span class="product_price"><span class="amount"><?php echo $NextJackpotValues['currencyForEuro']?></span></span><?php echo round($NextJackpotValues['homeEuroJackpot'])?></strong></span></p>
...
<p style="margin: 0px; font-size: 45px;"><span style="color: #ff0000; margin: 0px;"><strong><span class="product_price"><span class="amount"><?php echo $NextJackpotValues['currencyForLotto']?><?php echo round($NextJackpotValues['homelottoJackpot'])?></span></span>M</strong></span></p>

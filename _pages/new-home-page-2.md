...
Simply <a class="btn btn-default" href="/pricing/">Register</a> or <a class="btn btn-default" href="/login/">Login now</a> to start[/vc_column_text][/vc_column][/vc_row][vc_row full_width="stretch_row" bg_type="grad" css=".vc_custom_1448467112514{padding-top: 70px !important;padding-right: 70px !important;padding-bottom: 70px !important;padding-left: 70px !important;}" bg_grad="background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #991212), color-stop(100%, #320404));background: -moz-linear-gradient(top,#991212 0%,#320404 100%);background: -webkit-linear-gradient(top,#991212 0%,#320404 100%);background: -o-linear-gradient(top,#991212 0%,#320404 100%);background: -ms-linear-gradient(top,#991212 0%,#320404 100%);background: linear-gradient(top,#991212 0%,#320404 100%);"][vc_column css=".vc_custom_1446484572820{margin-bottom: 30px !important;}"][vc_column_text css_animation="top-to-bottom"]

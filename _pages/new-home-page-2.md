...
[button href="#" icon_size="12" class="blue-btn" target="" color="flat" dimension="normal" animation="" ]Find out more about the service  <span class="nodeLabelBox repTarget ">&lt;<span class="nodeTag ">i</span><span class="nodeAttr editGroup "> <span class="nodeName editable ">class</span>="<span class="nodeValue editable ">fa fa-angle-double-right</span>"</span><span class="nodeAttr editGroup "> <span class="nodeName editable ">style</span>="<span class="nodeValue editable ">font-size: 12px;</span>"</span><span class="nodeBracket editable insertBefore ">&gt;</span>&lt;/<span class="nodeTag ">i</span>&gt;</span>[/button]

[/vc_column_text][space height="15"][/vc_column][/vc_row][vc_row full_width="stretch_row" video_opts="" multi_color_overlay="" css=".vc_custom_1444400021711{padding-top: 35px !important;padding-bottom: 35px !important;}" bg_type="bg_color" bg_color_value="#eaeaea"][vc_column width="1/1"][vc_row_inner][vc_column_inner el_class="" width="1/3"][vc_column_text]
